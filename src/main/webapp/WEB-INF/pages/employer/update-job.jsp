...
<html>
    <head>
        ...
        <meta charset="UTF-8">
        <title>Cập nhật tin tuyển dụng</title>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="basic-form">
                                        <mvc:form id="job-form" action="${pageContext.request.contextPath}/employer/result-update-job"  method="post" modelAttribute="job">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col">
                                                    ...
                                                    <select class="form-control" id="gender" name="gender"> 
                                                        <option></option>
                                                        <c:if test="${job.gender == 'Không yêu cầu'}">
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    ...
                                                    <select class="form-control" id="experience" name="experience">
                                                        <option></option>
                                                        <c:if test="${job.experience == 'Không yêu cầu'}">
                                                            <option selected>Không yêu cầu</option>
                                                        </c:if>
                                                        <c:if test="${job.experience != 'Không yêu cầu'}">
                                                            <option >Không yêu cầu</option>
                                                ...
                                                <div class="col">
                                                    ...
                                                    <select class="form-control" id="workingform" name="workingFormEnum">
                                                        <c:forEach var="working" items="${workings}">
                                                            <c:if test="${working == job.workingFormEnum}">
                                            ...
                                            <div class="form-group">
                                                <textarea class="form-control" placeholder="Nhập quyền lợi" style="height: 150px;" id="right" name="right">${job.right}</textarea>
                                                <label class="form-message" style="color: red;"></label> 
                                            </div>
                                            ...
                                            <input onclick="location.href = '<c:url value="/employer//update-post/${job.id}"/>'" type="button" value="Hủy" class="btn btn-info"/>
                                        </mvc:form>
                                    </div>
                                </div>
                            </div>
