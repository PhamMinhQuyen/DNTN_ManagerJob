                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        <div class="basic-form">
                                            <mvc:form id="add-careers-form" action="${pageContext.request.contextPath}/admin/result-add-careers"  method="post" modelAttribute="careers">
                                                <c:if test="${action == 'update'}">
                                                     <input type="text" class="form-control input-default"
                                                            name="id" id="id" value="${careers.id}" hidden>
                                                </c:if>
                                                <div class="form-group">
                                                    <label class="form" for="name">Ngành nghề</label>
                                                    <span style=color:red;>*</span>
                                                    <input type="text" class="form-control input-default" value="${careers.name}"
                                                           name="name" id="name">
