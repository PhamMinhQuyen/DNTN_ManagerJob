                    ...
                    <div class="active-popular-post-carusel">
                        <c:forEach items="${posts}" var="post">
                            <div class="single-popular-post d-flex flex-row">
                                ...
                                <div class="details">
                                    <a href="<c:url value="/user/detail-post-user/${post.id}" />"><h4>${post.name}</h4></a>
                ...
                <div class="col-lg-8 post-list">
                    ...
                    <c:forEach items="${page.content}" var="post">
                        <div class="single-post d-flex flex-row" style="height: 160px;">
                            ...
                            <div class="details">
                                        <a href="<c:url value="/user/detail-post-user/${post.id}" />"><h4 style="color: #2980b9;">${post.name}</h4></a>
